 ...
 */
public class BleClientAtDeviceAdapter extends AbsListViewAdapter<BluetoothDevice> {
    public BleClientAtDeviceAdapter(Context context, List<BluetoothDevice> list) {
        super(context, list);
    }
